...
namespace DataGrid.Models
{
	...
	{
		// Updated connection string with better compatibility parameters for MySQL 9.1
		private static string connectionString = "Server=localhost;Port=3306;Database=gestion_theses;User ID=root;Password=;AllowPublicKeyRetrieval=true;SslMode=none;CharSet=utf8mb4;ConvertZeroDateTime=True;ConnectionTimeout=30;UseAffectedRows=true;OldGuids=true;UseCompression=true";
